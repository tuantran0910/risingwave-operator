...
const (
	MetaMemberService_Members_FullMethodName = "/meta.MetaMemberService/Members"
)
...
func (c *metaMemberServiceClient) Members(ctx context.Context, in *MembersRequest, opts ...grpc.CallOption) (*MembersResponse, error) {
	...
	err := c.cc.Invoke(ctx, MetaMemberService_Members_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedMetaMemberServiceServer must be embedded to have
...
func (UnimplementedMetaMemberServiceServer) testEmbeddedByValue()                           {}
...
func RegisterMetaMemberServiceServer(s grpc.ServiceRegistrar, srv MetaMemberServiceServer) {
	// If the following call panics, it indicates UnimplementedMetaMemberServiceServer was
...
func _MetaMemberService_Members_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: MetaMemberService_Members_FullMethodName,
	}
